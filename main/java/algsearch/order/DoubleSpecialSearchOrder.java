/*
 * @(#)DoubleSpecialSearchOrder.java	1.20, 2001/02/26
 *
...
/**
 * 类<code>DoubleSpecialSearchOrder</code>定义了含两个特殊元素的代数
 * 的搜索顺序。该类可用于对幺环乘法的搜索。
 *
 * @author 苑明理
...
public class DoubleSpecialSearchOrder implements SearchOrder {
     ...
     * 类的构造函数。
     */
    public DoubleSpecialSearchOrder(CayleyTable t) {
        x = 2;
        y = 2;
        table = t;
