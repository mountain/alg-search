/*
 * @(#)SingleSpecialAbelianSearchOrder.java	1.20, 2001/02/26
 *
...
/**
 * 类<code>SingleSpecialAbelianSearchOrder</code>定义了含一个特殊元素
 * 的交换代数的搜索顺序。该类可用于对交换群、交换环乘法等的搜索。
 *
 * @author 苑明理
...
public class SingleSpecialAbelianSearchOrder implements SearchOrder {
     ...
     * 类的构造函数。
     */
    public SingleSpecialAbelianSearchOrder(CayleyTable t) {
        x = 1;
        y = 1;
        table = t;
