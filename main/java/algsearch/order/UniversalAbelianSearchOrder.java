/*
 * @(#)UniversalAbelianSearchOrder.java	1.20, 2001/02/26
 *
...
/**
 * 类<code>UniversalSearchOrder</code>定义了最一般情形的交换代数的搜
 * 索顺序。该类可用于对对称半群等的搜索。
 *
 * @author 苑明理
...
public class UniversalAbelianSearchOrder implements SearchOrder {
     ...
     * 类的构造函数。
     */
    public UniversalAbelianSearchOrder(CayleyTable t) {
        x = 0;
        y = 0;
        table = t;
